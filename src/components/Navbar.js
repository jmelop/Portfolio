                        ...
                        <div className="relative max-w-xs w-full bg-white shadow-xl pb-12 flex flex-col overflow-y-auto">
                            ...
                            <div className="border-t border-gray-200 py-6 px-4 space-y-6">
                                <div className="flow-root">
                                    <a href="https://github.com/juanmlp" target="_blank" rel="noreferrer" className="-m-2 p-2 flex items-center">
                                        ...
                                        <span className="ml-3 block text-base font-medium text-gray-900">GitHub</span>
                                    </a>
                                </div>
                                <div className="flow-root">
                                    <a href="https://www.linkedin.com/in/juan-melo-p%C3%A9rez" target="_blank" rel="noreferrer" className="-m-2 p-2 flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-linkedin" viewBox="0 0 16 16">
                                            <path d="M0 1.146C0 .513.526 0 1.175 0h13.65C15.474 0 16 .513 16 1.146v13.708c0 .633-.526 1.146-1.175 
                                                ...
                                                .694.521 1.248 1.327 1.248h.016zm4.908 8.212V9.359c0-.216.016-.432.08-.586.173-.431.568-.878 1.232-.878.869 
                                        ...
                                        <span className="ml-3 block text-base font-medium text-gray-900">Linkedin</span>
                                    </a>
                                </div>
                                <div className="flow-root">
                                    <a href="https://www.instagram.com/jmelopdev/" target="_blank" rel="noreferrer" className="-m-2 p-2 flex items-center">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-instagram"
                                            ...
                                            <path d="M8 0C5.829 0 5.556.01 4.703.048 3.85.088 3.269.222 2.76.42a3.917 3.917 0 0 0-1.417.923A3.927 
                                                ...
                                                1.09.333 1.942.372C5.555 15.99 5.827 16 8 16s2.444-.01 3.298-.048c.851-.04 1.434-.174 1.943-.372a3.916 
                                                3.916 0 0 0 1.416-.923c.445-.445.718-.891.923-1.417.197-.509.332-1.09.372-1.942C15.99 10.445 16 10.173 
                                                16 8s-.01-2.445-.048-3.299c-.04-.851-.175-1.433-.372-1.941a3.926 3.926 0 0 0-.923-1.417A3.911 3.911 0 0 0 
                                                ...
                                                1.485.039.843.047 1.096.047 3.231s-.008 2.389-.047 3.232c-.035.78-.166 1.203-.275 1.485a2.47 2.47 0 
                                                0 1-.599.919c-.28.28-.546.453-.92.598-.28.11-.704.24-1.485.276-.843.038-1.096.047-3.232.047s-2.39-.009-3.233-.047c-.78-.036-1.203-.166-1.485-.276a2.478 2.478 
                                        ...
                                        <span className="ml-3 block text-base font-medium text-gray-900">Instagram</span>                                    </a>
                                </div>
                            </div>
                            <div className="border-t border-gray-200 py-6 px-4">
                                <a href="https://twitter.com/jmelop_" target="_blank" rel="noreferrer" className="-m-2 p-2 flex items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                                        <path d="M5.026 15c6.038 0 9.341-5.003 9.341-9.334 0-.14 0-.282-.006-.422A6.685 6.685 0 0 0 16 
                                                3.542a6.658 6.658 0 0 1-1.889.518 3.301 3.301 0 0 0 1.447-1.817 6.533 6.533 0 0 1-2.087.793A3.286 3.286 
                                                0 0 0 7.875 6.03a9.325 9.325 0 0 1-6.767-3.429 3.289 3.289 0 0 0 1.018 4.382A3.323 3.323 0 0 1 
                                                .64 6.575v.045a3.288 3.288 0 0 0 2.632 3.218 3.203 3.203 0 0 1-.865.115 3.23 3.23 0 0 1-.614-.057 
                                                3.283 3.283 0 0 0 3.067 2.277A6.588 6.588 0 0 1 .78 13.58a6.32 6.32 0 0 1-.78-.045A9.344 9.344 0 0
                                                0 5.026 15z" />
                                    </svg>
                                    <span className="ml-3 block text-base font-medium text-gray-900">Twitter</span>
                                </a>
                            </div>
                        </div>
                    </Transition.Child>
                            ...
                            <div className='grid grid-cols-1 mt-10 gap-x-4 md:grid-cols-1 lg:grid-cols-3 px-4'>
                                    ...
                                    <div className="h-full flex space-x-8">
                                        {navigation.pages.map((page) => (
                                            <a
                                                key={page.name}
                                                href={page.href}
                                                className="flex items-center text-sm font-medium text-gray-100 hover:text-gray-300">
                                                {page.name}
                                            </a>
                                        ))}
                                    </div>
                                </Popover.Group>
                                <div className="hidden lg:ml-4 lg:flex lg:ml-0 justify-center mb-4"></div>
                                <div className="ml-auto flex items-center mb-4 w-full border-b border-gray-200">
                                    <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-4">
                                        <a href="https://github.com/juanmlp" target="_blank" rel="noreferrer" className="text-sm font-medium 
