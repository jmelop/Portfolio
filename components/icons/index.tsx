...
export const GitHubIcon = ({ width = 15, height = 15 }: IconProps) => (
...
export const TwitterIcon = ({ width = 15, height = 15 }: IconProps) => (
  <svg viewBox="0 0 16 16" width={width} height={height} fill="currentColor">
...
export const EmailIcon = ({ width = 13, height = 13 }: IconProps) => (
  <svg viewBox="0 0 16 16" width={width} height={height} fill="currentColor">
